...
def before_request():
    ...
    if request.method == 'GET':
        get_list = [
            "/",
            "/apidocs/",
             "/python0ebx7/examusers/login" ,
            "/python0ebx7/examusers/register",
            '/python0ebx7/defaultuser/login',
            '/python0ebx7/users/login',
        ...
        post_list = [
            '/python0ebx7/defaultuser/register',
            '/python0ebx7/defaultuser/login',
            '/python0ebx7/users/register',
            '/python0ebx7/users/login',
            "/python0ebx7/examusers/login" ,
            "/python0ebx7/examusers/register"
        ]  # 免认证list
