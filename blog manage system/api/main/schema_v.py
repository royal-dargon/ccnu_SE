...
@main_bp.route("/python0ebx7/cal/<tableName>/<columnName>", methods=['GET'])
def python0ebx7_cal(tableName, columnName):
    '''
    计算规则接口
    '''
...
@main_bp.route("/python0ebx7/file/download", methods=['GET'])
def python0ebx7_file_download():
    '''
    '''
    if request.method == 'GET':
...
@main_bp.route("/python0ebx7/file/upload", methods=['POST'])
def python0ebx7_file_upload():
    '''
    '''
...
@main_bp.route("/python0ebx7/follow/<tableName>/<columnName>/<level>/<parent>", methods=['GET'])
def python0ebx7_follow_level(tableName, columnName, level,parent):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python0ebx7/follow/<tableName>/<columnName>", methods=['GET'])
def python0ebx7_follow(tableName, columnName):
    '''
...
@main_bp.route("/python0ebx7/location", methods=['GET'])
def python0ebx7_location():
    '''
...
@main_bp.route("/python0ebx7/matchFace", methods=['GET'])
def python0ebx7_matchface():
    '''
    baidubce百度人脸识别
    '''
    if request.method == 'GET':
...
@main_bp.route("/python0ebx7/option/<tableName>/<columnName>", methods=['GET'])
def python0ebx7_option(tableName, columnName):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python0ebx7/remind/<tableName>/<columnName>/<type>", methods=['GET'])  #
def python0ebx7_remind(tableName, columnName,type):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, 'data': []}
...
@main_bp.route("/python0ebx7/sh/<tableName>", methods=['POST'])
def python0ebx7_sh(tableName):
    '''
    '''
    if request.method == 'POST':
        ...
        logging.warning("python0ebx7_sh.res=====>{}".format(res))
        return jsonify(msg)

@main_bp.route("/python0ebx7/upload/<fileName>", methods=['GET'])
def python0ebx7_upload(fileName):
    '''
    上传接口
    '''
    if request.method == 'GET':
...
@main_bp.route("/python0ebx7/group/<tableName>/<columnName>", methods=['GET'])
...
@main_bp.route("/python0ebx7/value/<tableName>/<xColumnName>/<yColumnName>", methods=['GET'])
